...
INSERT INTO `b04_ind_cfg` VALUES ('DS0106000000', '1', '数据年份', 'data_year', 'string', '1', '', '', 'data_cycle');
INSERT INTO `b04_ind_cfg` VALUES ('DS0106000000', '2', '区域编号', 'zone_cd', 'string', '1', '', '', 'region_cd');
INSERT INTO `b04_ind_cfg` VALUES ('DS0106000000', '3', '分析维度编号', 'dim_cd', 'string', '1', '', '', 'dim_cd');
INSERT INTO `b04_ind_cfg` VALUES ('DS0106000000', '4', '全社会固定资产投资', 'investment_fixed_assets_whole_society', 'string', '0', '固定资产投资金额', 'I0106010001', '');
INSERT INTO `b04_ind_cfg` VALUES ('DS0106000000', '5', '全社会固定资产投资-城镇固定资产投资', 'wsfai_urban_fixed_assets_investment', 'string', '0', '固定资产城镇投资金额', 'I0106010002', '');
INSERT INTO `b04_ind_cfg` VALUES ('DS0106000000', '6', '全社会固定资产投资-城镇固定资产投资-房地产开发投资', 'wsfai_ufai_real_estate_development_investment', 'string', '0', '固定资产城镇房地产开发投资金额', 'I0106010003', '');
INSERT INTO `b04_ind_cfg` VALUES ('DS0106000000', '7', '全社会固定资产投资-农村固定资产投资', 'tsifa_rural_investment_fixed_assets', 'string', '0', '固定资产农村投资金额', 'I0106010004', '');
INSERT INTO `b04_ind_cfg` VALUES ('DS0106000000', '8', '全社会固定资产投资-基础设施投资', 'tsifa_infrastructure_investment', 'string', '0', '固定资产基础设施投资金额', 'I0106010005', '');
INSERT INTO `b04_ind_cfg` VALUES ('DS0106000000', '9', '全社会固定资产投资-建筑安装投资', 'investment_fixed_assets_construction_and_installation', 'string', '0', '固定资产建筑安装投资金额', 'I0106010006', '');
INSERT INTO `b04_ind_cfg` VALUES ('DS0106000000', '10', '新增固定资产', 'newly_added_fixed_assets', 'string', '0', '新增固定资产金额', 'I0106010007', '');
INSERT INTO `b04_ind_cfg` VALUES ('DS0106000000', '11', '全社会固定资产投资比上年增长', 'fixed_asset_investment_whole_society_increased_over_previous_yea', 'string', '0', '固定资产投资额同比增长比例', 'I0106010008', '');
INSERT INTO `b04_ind_cfg` VALUES ('DS0106000000', '12', '全社会固定资产投资比上年增长-城镇固定资产投资', 'investment_fixed_assets_urban_areas_increased_from_previous_year', 'string', '0', '固定资产城镇投资额同比增长比例', 'I0106010009', '');
INSERT INTO `b04_ind_cfg` VALUES ('DS0106000000', '13', '房地产开发投资', 'real_estate_development_investment', 'string', '0', '固定资产城镇房地产开发投资额同比增长比例', 'I0106010010', '');
INSERT INTO `b04_ind_cfg` VALUES ('DS0106000000', '14', '农村固定资产投资', 'investment_rural_fixed_assets', 'string', '0', '固定资产农村投资额同比增长比例', 'I0106010011', '');
INSERT INTO `b04_ind_cfg` VALUES ('DS0106000000', '15', '基础设施投资', 'infrastructure_investment', 'string', '0', '固定资产基础设施投资额同比增长比例', 'I0106010012', '');
INSERT INTO `b04_ind_cfg` VALUES ('DS0106000000', '16', '建筑安装投资', 'construction_and_installation_investment', 'string', '0', '固定资产建筑安装投资额同比增长比例', 'I0106010013', '');
