...
CREATE TABLE `b05_dm_col` (
  ...
  `tgt_tbl_part` int(11) NOT NULL DEFAULT '0',
  ...
  PRIMARY KEY (`tgt_tbl_nm`,`tgt_col_num`,`tgt_tbl_part`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

-- ----------------------------
-- Records of b05_dm_col
-- ----------------------------
INSERT INTO `b05_dm_col` VALUES ('interdb.M01_POPU_TOTAL_INFO', '0', '1', 'Data_Dt', '数据日期', 'T1.Data_Cycle');
INSERT INTO `b05_dm_col` VALUES ('interdb.M01_POPU_TOTAL_INFO', '0', '2', 'Zone_Cd', '地区代码', 'T1.Region_Cd');
INSERT INTO `b05_dm_col` VALUES ('interdb.M01_POPU_TOTAL_INFO', '0', '3', 'rsdt_popu_qty', '常住人口数', 'T1.I0103020001');
INSERT INTO `b05_dm_col` VALUES ('interdb.M01_POPU_TOTAL_INFO', '0', '4', 'rsdt_popu_ntrly_gr', '常住人口自然增长率', 'T1.I0103020009');
INSERT INTO `b05_dm_col` VALUES ('interdb.M01_POPU_TOTAL_INFO', '0', '5', 'rsdt_popu_qty_add', '常住人口同比增长', '(T1.I0103020001-T2.I0103020001)/T2.I0103020001');
INSERT INTO `b05_dm_col` VALUES ('interdb.M01_POPU_TOTAL_INFO', '0', '6', 'hpopu_qty', '户籍人口数', 'T1.I0103020010');
INSERT INTO `b05_dm_col` VALUES ('interdb.M01_POPU_TOTAL_INFO', '0', '7', 'hpopu_qty_add', '户籍人口同比增长', '(T1.I0103020010-T2.I0103020010)/T2.I0103020010');
INSERT INTO `b05_dm_col` VALUES ('interdb.M01_POPU_TOTAL_INFO', '0', '8', 'field1', '预留字段', '\'9\'');
...
CREATE TABLE `b05_dm_tbl` (
  ...
  PRIMARY KEY (`tgt_tbl_nm`,`src_tbl_num`,`tgt_tbl_part`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;

-- ----------------------------
-- Records of b05_dm_tbl
-- ----------------------------
INSERT INTO `b05_dm_tbl` VALUES ('interdb.M01_POPU_TOTAL_INFO', '0', '1', 'T1', 'DS010003110000', '03', '', '', '', 'I0103020001,I0103020009,I0103020010');
INSERT INTO `b05_dm_tbl` VALUES ('interdb.M01_POPU_TOTAL_INFO', '0', '2', 'T2', 'DS010003110000', '03', '${LASTMONTH}', '', '', 'I0103020001,I0103020010');
