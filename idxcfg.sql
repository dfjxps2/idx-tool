...
--
-- Table structure for table `b05_dm_col`
--
...
--
-- Dumping data for table `b05_dm_col`
--

LOCK TABLES `b05_dm_col` WRITE;
/*!40000 ALTER TABLE `b05_dm_col` DISABLE KEYS */;
INSERT INTO `b05_dm_col` VALUES ('interdb.M01_POPU_TOTAL_INFO',1,'Data_Dt','数据日期','T1.Data_Cycle'),('interdb.M01_POPU_TOTAL_INFO',2,'Zone_Cd','地区代码','T1.Region_Cd'),('interdb.M01_POPU_TOTAL_INFO',3,'rsdt_popu_qty','常住人口数','T1.I0103020001'),('interdb.M01_POPU_TOTAL_INFO',4,'rsdt_popu_ntrly_gr','常住人口自然增长率','T1.I0103020009'),('interdb.M01_POPU_TOTAL_INFO',5,'rsdt_popu_qty_add','常住人口同比增长','(T1.I0103020001-T2.I0103020001)/T2.I0103020001'),('interdb.M01_POPU_TOTAL_INFO',6,'hpopu_qty','户籍人口数','T1.I0103020010'),('interdb.M01_POPU_TOTAL_INFO',7,'hpopu_qty_add','户籍人口同比增长','(T1.I0103020010-T2.I0103020010)/T2.I0103020010'),('interdb.M01_POPU_TOTAL_INFO',8,'field1','预留字段','\'9\'');
/*!40000 ALTER TABLE `b05_dm_col` ENABLE KEYS */;
UNLOCK TABLES;

--
-- Table structure for table `b05_dm_tbl`
--
...
--
-- Dumping data for table `b05_dm_tbl`
--

LOCK TABLES `b05_dm_tbl` WRITE;
/*!40000 ALTER TABLE `b05_dm_tbl` DISABLE KEYS */;
INSERT INTO `b05_dm_tbl` VALUES ('interdb.M01_POPU_TOTAL_INFO',1,'T1','DS010003110000','03','2018','','','I0103020001,I0103020009,I0103020010'),('interdb.M01_POPU_TOTAL_INFO',2,'T2','DS010003110000','03','${LASTYEAR}','','','I0103020001,I0103020010');
/*!40000 ALTER TABLE `b05_dm_tbl` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2018-12-04 16:39:23
